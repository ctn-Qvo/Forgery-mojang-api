...
<script>
  ...
  (function test() {
    var testName = "ctn32";
    var result = generateOfflineUUID(testName);
    console.log("离线UUID测试: " + testName + " -> " + result);
    if (result === "7bcd7cac-982e-3be6-8446-1ed3b7364c42") {
      console.log("离线UUID生成正确");
    } else {
      console.warn("离线UUID生成可能不正确，请检查库加载是否成功");
    }
  })();
